...
public:
	...
	{
		// 7FF66EC619E0
		void (*ClearAbility)(class UAbilitySystemComponent* AbilitySystemComponent, const struct FGameplayAbilitySpecHandle& Handle) = decltype(ClearAbility)(0x6119e0 + uintptr_t(GetModuleHandle(0)));
