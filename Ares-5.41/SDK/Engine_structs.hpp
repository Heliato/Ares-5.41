...
{
	TMap<int32_t, int32_t> ItemMap; // 0x50 / 80
	int32_t IDCounter; // 0x4
	int32_t	ArrayReplicationKey; // 0x4
	TMap<int32_t, FFastArraySerializerGuidReferences> GuidReferencesMap; // 0x50 / 80
	int32_t CachedNumItems; // 0x4
	int32_t CachedNumItemsToConsiderForWriting; // 0x4
